...
const MACRO_SECTIONS = [
  ...
  { label: 'World-CPI-JP', script: 'seed-world-cpi-estat.mjs', seedMetaKey: 'economic:world-cpi-estat', canonicalKey: 'economic:world-cpi:estat:v1', completionMetaKey: 'seed-completion:economic:world-cpi-estat', intervalMs: DAY, timeoutMs: 120_000 },
